<template>
  <li class="our-project__item">
    <div class="our-project__star" v-if="project.showStar === true">
      <svg
        width="36"
        height="35"
        viewBox="0 0 36 35"
    ...
    <div class="our-project__wrapper-img">
      <img class="our-project__img" :src="project.img" :alt="project.title" />
    </div>
    <div class="our-project__footer">
      <div class="our-project__footer-left">
        <h2 class="our-project__title title">
          {{ project.title }}
        </h2>
        <p class="our-project__model paragraph">
          {{ project.model }}
        </p>
      </div>
      <div class="our-project__footer-right">
        <router-link
          :to="{ name: 'project-id', params: { id: project.id } }"
          class="our-project__btn btn-reset"
        >
          <svg
            width="70"
            height="70"
