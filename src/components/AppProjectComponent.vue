<template>
  <div class="project" @click="showDetails(blog.id)">
    <div class="project-content">
      <div class="project-content-star" v-if="project.showStar === true">
  ...
  <defs>
    <filter id="filter0_d_993_156" x="0.186424" y="0.431396" width="35.6271" height="34.3619" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
      ...
      <div class="project-content-img-wrapper">
        <img class="project-content-img" :src="project.img" alt="project-img" />
      </div>
      <div class="project-footer">
        <div>
          <div class="project-title">
            <p class="project-title__text">
              {{ project.title }}
            </p>
          </div>
          <div class="project-model">
            <p class="project-model__text">
              {{ project.model }}
            </p>
          </div>
        </div>
